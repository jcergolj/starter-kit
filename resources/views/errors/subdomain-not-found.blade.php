...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Source+Sans+3:wght@400;500;600&display=swap"
        rel="stylesheet"
    />
...
>
    <div class="max-w-md text-center">
        ...
        <h1 class="mb-2 text-2xl font-bold" style="color: var(--color-text)">{{ __('Subdomain Not Found') }}</h1>
        ...
        <a
            href="{{ $mainUrl }}"
            class="inline-flex items-center justify-center rounded-lg px-6 py-3 font-semibold text-white transition-colors"
